    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-black tracking-tighter">GODEL</span>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start mb-32">
          <div>
            ...
            <div className="space-y-6 text-xl text-black/60 leading-relaxed">
              ...
              <p>
                Vishwanath Venkat founded Godel Technologies to solve this gap, synthesizing a decade of expertise and 60+ global projects into a Technical Co-Founding Engine.
              </p>
            </div>
          </div>
  ...
  <footer className="px-6 md:px-12 py-12 border-t border-gray-100">
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
      <div className="flex items-center gap-2">
        ...
        <span className="text-lg font-black tracking-tighter">GODEL</span>
      </div>
      ...
      <p className="text-sm font-medium text-black/20">
        © {new Date().getFullYear()} Godel Technologies. All rights reserved.
      </p>
    </div>
  </footer>
);
